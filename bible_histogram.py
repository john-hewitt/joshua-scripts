# Takes a directory with full bible text corpora, and produces a histogram
# of tokens/counts for each language. (Presumtively, each language's bibles
# have been compiled into one already.)
import argparse
